...
// Check Route Availability => /check-route-availability/:id (id is custom route_id like RT001)
router.get("/:id", async (req, res) => {
    try {
        ...
        return res.status(200).json({ message: "Route found", routeId: id, routeStatus });
    } catch (error) {
